...
def app_update_payload(app=None, current_version_name="", current_version_code=0):
    ...
    return {
        ...
        "apk_size": int(snapshot.get("apk_size") or 0),
        "package_name": "com.xvpn.android",
        "signing_cert_sha256": "86053d4bef63c6de1d77a0984c3060acea67756ace42d540c18c83f2d1ae66fb",
